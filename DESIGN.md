...
### Philosophy
Warm coral accent on deep blue-black. Every developer tool defaults to cold blue. Coral leans into its name. The primary accent uses a gradient for energy.
...
| 2026-03-28 | Warm coral accent over system blue | Product is named Coral — lean into it. Every dev tool uses blue. Immediate differentiation. |
