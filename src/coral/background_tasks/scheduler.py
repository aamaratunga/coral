...
class JobScheduler:
    ...
    def __init__(self, store: ScheduleStore, max_concurrent: int | None = None) -> None:
        ...
        self._max_concurrent = max_concurrent or int(os.environ.get("CORAL_MAX_CONCURRENT_JOBS", "5"))
    ...
    async def _launch_run(self, run_id: int, config: dict) -> None:
        ...
        from coral.tools.session_manager import launch_claude_session
    ...
    async def _fire_webhook(
        ...
        from coral.tools.run_callback import send_run_callback
